...
export default {
  ...
  entry: {
    'vendor': [
      ...
      'react', 'react-dom', 'react-router', 'redux', 'react-redux', 'react-router-redux', 'redux-thunk'
    ],
    'main': 'index'
  },
  output: {
  ...
  module: {
    loaders: [
      ...
      {
        test: /\.scss$/,
        loader: 'style!css?modules&importLoaders=2&sourceMap&localIdentName=[local]_[hash:base64:5]!postcss!sass?sourceMap'
      },
      {
        test: /\.css$/,
